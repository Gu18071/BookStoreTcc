...
<section class="messages">
   ...
   ?>
   <div class="box">
      <p> ID de usuário: <span><?php echo $fetch_message['user_id']; ?></span> </p>
      ...
      <a href="admin_contacts.php?delete=<?php echo $fetch_message['id']; ?>" onclick="return confirm('Deseja deletar essa mensagem?');" class="delete-btn">Deletar mensagem</a>
   </div>
   <?php
      };
   }else{
